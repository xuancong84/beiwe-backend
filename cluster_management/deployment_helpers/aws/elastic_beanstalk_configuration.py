...
from deployment_helpers.constants import get_beiwe_environment_file_path


def get_beiwe_environment_settings(eb_environment_name):
    with open(get_beiwe_environment_file_path(eb_environment_name), 'r') as f:
        return json.load(f)
