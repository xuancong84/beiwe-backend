...
class StudyDeviceSettings( DatabaseObject ):
    ...
    DEFAULTS = {#device sensors (listeners)
                ...
                #text strings
                "about_page_text": "Beiwe is an application that runs on your cell phone and helps researchers collect information about your health and behaviors. It asks you to fill out short surveys, and to make a recording of your voice, once a day. Beiwe continuously collects information about your location (using your phone's GPS) and how much you move around (using your phone's accelerometer). It also monitors how much you use your phone for calling and texting, and it keeps track of the different people you communicate with. Importantly, Beiwe does not record the names or phone numbers of anyone you communicate with. While it can tell if you call the same person more than once, it does not know who that person is. Beiwe does not record the content of your text messages or phone calls. It also keeps track of the different Wi-Fi networks in your area, but the names of those networks are replaced with random codes. Finally, Beiwe can tell if you are near another phone that is also running this application.\n\nAlthough Beiwe collects a large amount of data, all of this data is processed to protect your privacy. This means that the application does not know your name, your phone number, or anything else that could identify you. Beiwe only knows you by an identification number. Because Beiwe does not know who you are, it cannot communicate with your clinician if you are ill or in danger. Researchers will not review the data Beiwe collects until the end of the study. To make it easier for you to connect with your clinician, the 'Call my Clinician' button appears at the top of every page. In order for the button to work, you must enter your clinician's phone number into Beiwe. You can change it as often as needed.\n\nBeiwe was conceived and designed by Dr. Jukka-Pekka 'JP' Onnela at the Harvard School of Public Health. The research study in which you are enrolled is run by Dr. Roy Perlis at Massachusetts General Hospital. The software was built by Zagaran, Inc., in Cambridge, Massachusetts.",
                "call_clinician_button_text": "Call My Clinician",
                "consent_form_text": "I agree to enroll in this study.",
                "survey_submit_success_toast_text": "Thank you for completing the survey.  Don't forget, no clinician will see your answers.  So, if you need help or you're thinking about harming yourself, please call your clinician.  You can also press the 'Call My Clinician' button above to call your clinician."
            }
    @classmethod
