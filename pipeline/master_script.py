...
def run(ecr_repo_name, comp_env_role, comp_env_name, queue_name, job_defn_name, lambda_role, function_name, rule_name, **_):
    docker_script.run(ecr_repo_name)
    job_queue_script.run(comp_env_role, comp_env_name, queue_name, job_defn_name)
