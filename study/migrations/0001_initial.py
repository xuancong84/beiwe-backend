# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-09-13 10:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_sections', study.base_models.JSONTextField(default=b'{"study_tasks": {"text": "", "more": ""}, "data_use": {"text": "", "more": ""}, "withdrawing": {"text": "", "more": ""}, "privacy": {"text": "", "more": ""}, "study_survey": {"text": "", "more": ""}, "welcome": {"text": "", "more": ""}, "data_gathering": {"text": "", "more": ""}, "time_commitment": {"text": "", "more": ""}}')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_id', models.CharField(help_text='ID used for naming S3 files', max_length=24, unique=True, validators=[study.validators.LengthValidator(24)])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('deleted', models.BooleanField(default=False)),
                ('content', study.base_models.JSONTextField(default='[]', help_text='JSON blob containing information about the survey questions.')),
                ...
                ('settings', study.base_models.JSONTextField(default='{}', help_text='JSON blob containing settings for the survey.')),
                ('timings', study.base_models.JSONTextField(default=b'[[], [], [], [], [], [], []]', help_text='JSON blob containing the times at which the survey is sent.')),
                ('object_id', models.CharField(max_length=24, unique=True, validators=[study.validators.LengthValidator(24)])),
        ...
        migrations.AddField(
            ...
            name='participant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='files_to_process', to='study.Participant'),
        ),
        migrations.AddField(
            model_name='filetoprocess',
            name='study',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='files_to_process', to='study.Study'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='participant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='chunk_registries', to='study.Participant'),
        ),
        migrations.AddField(
            model_name='chunkregistry',
            name='study',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='chunk_registries', to='study.Study'),
        ),
        migrations.AddField(
            model_name='chunkregistry',
            name='survey',
